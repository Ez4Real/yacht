...
export type Body_charters_create_charter = {
    charter_base: CharterBase;
    banner_image: (Blob | File);
    block_1_image?: ((Blob | File) | null);
    block_2_image?: ((Blob | File) | null);
};

export type Body_charters_update_charter = {
    charter_base: CharterUpdateBase;
...
export type CharterImagePublic = {
    url: string;
...
export type CharterImageType = 'banner' | 'block_1' | 'block_2';

export type CharterPublic = {
    title?: string;
    description?: string;
    content1?: string;
    content2?: (string | null);
    ...
    block_1_image?: (CharterImagePublic | null);
    block_2_image?: (CharterImagePublic | null);
};

export type ChartersPublic = {
    data: Array<CharterPublic>;
    count: number;
};

export type CharterUpdateBase = {
    title: (string | null);
...
export type ChartersReadChartersData = {
    limit?: number;
    skip?: number;
};

export type ChartersReadChartersResponse = (ChartersPublic);

export type ChartersCreateCharterData = {
    formData: Body_charters_create_charter;
};

export type ChartersCreateCharterResponse = (CharterPublic);

export type ChartersReadCharterData = {
    id: string;
};

export type ChartersReadCharterResponse = (CharterPublic);

export type ChartersUpdateCharterData = {
    formData: Body_charters_update_charter;
    id: string;
};

export type ChartersUpdateCharterResponse = (CharterPublic);

export type ChartersDeleteCharterData = {
    id: string;
};

export type ChartersDeleteCharterResponse = (Message);
