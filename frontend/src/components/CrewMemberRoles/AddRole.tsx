...
const AddRole = () => {
  ...
  const mutation = useMutation({
    mutationFn: (data: CrewMemberRoleCreate) =>
      CrewMemberRolesService.createCrewMemberRole({ requestBody: data }),
    onSuccess: () => {
    ...
    onSettled: () => {
      queryClient.invalidateQueries({ queryKey: ["crew_member_roles"] })
    },
  })
